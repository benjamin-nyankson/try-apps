  ...
  return (function o(a, s, u) {
  ...
  })(
    {
      ...
      2: [
        ...
        { "./OneDriveApp": 3, "./controllers/Oauth": 7 },
      ],
      3: [
        function (e, t, r) {
          !(function (e, t, r, i, n, o, a, s) {
            ...
            var u = (function () {
              ...
              t.save = function (e) {
                if (t.isReady()) {
                  e ||
                    r.throwError(
                      new o.default(i.default.unknown, "missing saver options")
                    );
            ...
            0,
            r,
            e("./utilities/ErrorHandler"),
            e("./models/ErrorType"),
            e("./utilities/Logging"),
            e("./models/OneDriveSdkError"),
            e("./controllers/Picker"),
            e("./controllers/Saver")
          );
        },
        {
        ...
        function (e, t, r) {
          !(function (e, t, d, p, f, c, h, v, m, g, y) {
            ...
            t.getItems = function (e, t, r) {
              for (
                var i = [], n = { webUrl: null, value: [] }, o = 0, a = e.value;
                o < a.length;
                o++
              ) {
                var s = a[o];
            ...
            function u(o, e, t) {
              var a = m.appendToPath(
                  b(o, e.apiEndpointUrl),
                  v.format("{0}.createLink", e.apiActionNamingSpace)
                ),
                r = new g.default({
                  url: a,
                  clientId: e.clientId,
              ...
              return new y.Promise(function (i, n) {
                r.start(
                  function (e, t, r) {
                    f.default.logMessage(
                      v.format("POST createLink succeeded via path {0}", a)
                    );
                  ...
                  function (e, t, r) {
                    f.default.logMessage(
                      v.format("POST createLink failed via path {0}", a)
                    );
                    n({
                      errorCode: p.default[p.default.webRequestFailure],
                      message: t,
            ...
            t.saveItemByFormUpload = function (u, l, e, d, c) {
              ...
              return new y.Promise(function (a, s) {
                window.File && e instanceof window.File
                  ? (t = new FileReader())
                  : s(
                      new h.default(
                        p.default.unsupportedFeature,
                ...
                t.onerror = function (e) {
                  ...
                  s(
                    new h.default(
                      p.default.fileReaderFailure,
                      "failed to read or upload the file, see console log for details"
                    )
                  );
                };
                t.onload = function (e) {
                  var t = m.appendToPath(
                      b(u, d.apiEndpointUrl),
                      "children('" + l.name + "')/content"
                    ),
                    r = {};
                  ...
                  n.upload(
                    o,
                    function (e, t) {
                      a({ webUrl: null, value: [JSON.parse(e.responseText)] });
                    },
                    function (e, t, r) {
                      s(
                        new h.default(
                          p.default.webRequestFailure,
                          v.format(
                            "file uploading failed by form uplaod with HTTP status: {0}",
                            t
                          )
                        )
                      );
            ...
            t.saveItemByUriUpload = function (e, t, r, i) {
              if (
                i.apiEndpoint === d.default.filesV2 ||
                i.apiEndpoint === d.default.graph_odb
              )
              ...
              var n,
                o = m.appendToPath(b(e, i.apiEndpointUrl), "children"),
                a = { Prefer: "respond-async" };
              a.Authorization = "bearer " + i.accessToken;
              t[
                ((n = i.apiEndpoint),
                n === d.default.graph_odb || n === d.default.graph_odc
                        ...
                        if (200 === t || 201 === t) {
                          ...
                          n(
                            new h.default(
                              p.default.webRequestFailure,
                              v.format(
                                "file uploading failed by data uri with HTTP status: {0}",
                                t
                              )
                            )
                          );
                      ...
                      function (e, t, r) {
                        n(
                          new h.default(
                            p.default.webRequestFailure,
                            v.format(
                              "file uploading failed with HTTP status: {0}",
                              t
                            )
                          )
                        );
                ...
                ? ((s = l),
                  new y.Promise(function (i, n) {
                        ...
                        if (202 === t) {
                          ...
                          n(
                            new h.default(
                              p.default.webRequestFailure,
                              v.format(
                                "create upload by url job failed with HTTP status: {0}",
                                t
                              )
                            )
                          );
                    ...
                    new y.Promise(function (n, a) {
                                ...
                                default:
                                  n(
                                    new h.default(
                                      p.default.webRequestFailure,
                                      v.format(
                                        "polling upload job failed with HTTP status: {0}",
                                        t
                                      )
                                    )
                                  );
                      ...
                      return T({ id: e }, i).then(function (e) {
                        var t = { webUrl: null, value: [e] };
            ...
            t.getUserTenantUrl = function (e) {
              var t = m.appendQueryString(
                  m.appendToPath(e.apiEndpointUrl, "me"),
                  "$select",
                  "mySite"
                ),
                r = {};
                ...
                o.start(
                  function (e, t) {
                    ...
                    r.mySite
                      ...
                      : n(
                          new h.default(
                            p.default.badResponse,
                            v.format(
                              "Cannot find the personal tenant url, response text: {0}",
                              e.responseText
                            )
                          )
                        );
                  ...
                  function (e, t, r) {
                    n(
                      new h.default(
                        p.default.webRequestFailure,
                        v.format(
                          "graph/me request failed, status code: '{0}', response text: '{1}'",
                          g.default.statusCodeToString(t),
                          e.responseText
                        )
                      )
                    );
            ...
            function b(e, t) {
              var r;
              r =
                e.parentReference && e.parentReference.driveId
                  ? m.appendToPath("drives", e.parentReference.driveId)
                  : "drive";
            ...
            0,
            r,
            e("../models/ApiEndpoint"),
            e("../models/ErrorType"),
            e("../utilities/Logging"),
            e("../utilities/ObjectUtilities"),
            e("../models/OneDriveSdkError"),
            e("../utilities/StringUtilities"),
            e("../utilities/UrlUtilities"),
            e("../utilities/XHR"),
            e("es6-promise")
          );
        },
          ...
          !(function (e, t, n, o, d, c, p, f, r, a, i, h, s, u, v, m, l) {
            ...
            var g = (function () {
              ...
              e.prototype.launch = function (e) {
                var l = this;
                return this.buildOauthPromise(e)
                  .then(function (e) {
                  ...
                  .then(function (e) {
                    ...
                    e.type ||
                      p
                        .throwError(
                          new h.default(
                            f.default.badResponse,
                            m.format(
                              "received bad response from picker UX: {0}",
                              JSON.stringify(e)
                            )
                          )
                        )
                        .exposeToPublic();
                    if ("switch" === e.type) return l.launch(!0);
                    if ("success" === e.type) {
                      for (
                        var r = [], i = !1, n = 0, o = e.items;
                        n < o.length;
                        n++
                      ) {
                        var a = o[n];
                      ...
                      var s = { webUrl: null, value: r },
                        u = void 0;
                      if (
                        !t.needAPICall() ||
                        (i && "rps" === t.accessToken.toLowerCase())
                      ) {
                        l.invokerOptions.forceAuthenticate &&
                      ...
                      return u.then(function (e) {
                        l.oauthResponse &&
                          (e.accessToken = l.oauthResponse.accessToken);
                        l.apiRequestConfig
                          ? (e.apiEndpoint = l.apiRequestConfig.apiEndpointUrl)
                          : l.loginHint &&
                            l.loginHint.endpointHint === c.default.aad &&
                            (e.apiEndpoint = d.default.GRAPH_URL);
                        t.success(e);
                        return e;
                      });
                    }
                    if ("cancel" === e.type) {
                      t.cancel();
                      return v.Promise.resolve({ webUrl: null, value: null });
                    }
                  });
              };
              e.prototype.buildOauthPromise = function (e) {
                return e || this.invokerOptions.needOauth()
                  ? i.auth(
                      i.buildOauthConfig(this.invokerOptions, e),
                      this.popup
                    )
              ...
              e.prototype.buildPickerUI = function (e) {
                ...
                if (e) {
                  ...
                  r = a.updateLoginHint(
                    this.invokerOptions.clientId,
                    this.oauthResponse.idToken,
                    this.invokerOptions
                  );
                } else {
                  this.invokerOptions.endpointHint !== c.default.msa &&
                    this.invokerOptions.endpointHint !== c.default.tenant &&
                    p
                      .throwError(
                        new h.default(
                          f.default.optionsError,
                          "must specify the endpointHint in advanced options as 'api.onedrive.com' for customer picker or the url for business picker/tenant"
                        )
                      )
                      .exposeToPublic();
                ...
                return (
                  (this.loginHint = r).apiEndpoint === n.default.graph_odb
                    ? o.getUserTenantUrl(this.buildApiConfig())
                    : v.Promise.resolve(void 0)
                ).then(function (e) {
                  i.pickerUX = s.generatePickerUX(
                    r.apiEndpoint,
                    r.endpointHint === c.default.tenant
                      ? i.invokerOptions.siteUrl
                      : e
                  );
                  var t = i.buildPickerUXConfig(i.invokerOptions);
                  i.invokerOptions.navEntryLocation &&
                    (t.entryLocation = i.invokerOptions.navEntryLocation);
                  i.invokerOptions.navSourceTypes &&
                    (t.sourceTypes = i.invokerOptions.navSourceTypes);
                  i.invokerOptions.linkType &&
                    (t.linkType = i.invokerOptions.linkType);
              ...
              e.prototype.buildApiConfig = function () {
                this.loginHint ||
                  p
                    .throwError(
                      new h.default(
                        f.default.internalError,
                        "missing loginHint when trying to build API request"
                      )
                    )
                    .exposeToPublic();
                this.oauthResponse ||
                  this.invokerOptions.accessToken ||
                  p
                    .throwError(
                      new h.default(
                        f.default.internalError,
                        "missing access token when trying to build API request"
                      )
                    )
                    .exposeToPublic();
                var e = null,
                ...
                switch (this.loginHint.apiEndpoint) {
                  ...
                  default:
                    p.throwError(
                      new h.default(
                        f.default.internalError,
                        "apiEndpoint in loginHint is not correct"
                      )
                    );
                }
                return {
                  accessToken: this.oauthResponse
          ...
          !(function (e, t, d, c, p, f, i, n, o, a) {
            ...
            t.getLoginHint = function (e) {
              e ||
                i.throwError(
                  new o.default(
                    n.default.optionsError,
                    "invoker option is not defined!"
                  )
                );
              var t = (c.getCacheItem(h) || {})["od7-" + e.clientId];
              return t
                ? e.endpointHint !== t.endpointHint
                  ? null
                  : e.loginHint && e.loginHint !== t.loginHint
                  ? null
                  : t
                : null;
            };
            ...
            t.parseIdToken = function (e) {
              e ||
                i.throwError(
                  new o.default(
                    n.default.badResponse,
                    "id_token is missing in oauth response"
                  )
                );
              ...
              r.tid ||
                i.throwError(
                  new o.default(
                    n.default.badResponse,
                    "tid is missing in id_token response"
                  )
                );
              r[s] ||
                i.throwError(
                  new o.default(
                    n.default.badResponse,
                    "preferred_username is missing in id_token response"
                  )
                );
              return { tid: r.tid, preferredUserName: r[s] };
            };
          })(
            0,
            r,
          ...
          !(function (e, t, r, a, u, s, l, d, c, p, i, f) {
            ...
            t.onAuth = function () {
              u.onDocumentReady(function () {
                ...
                (e[m] || ((e[o] || e[n]) && e[g])) &&
                  window.opener &&
                  T(e, new r.default(window.opener));
              });
            };
            function T(e, t) {
              u.displayOverlay();
                ...
                ? (function (e) {
                    ...
                    switch (e.endpoint) {
                      ...
                      case c.default.AADv2:
                        t =
                          ((i =
                            "profile openid https://graph.microsoft.com/User.Read " +
                            (r = e).scopes
                              .map(function (e) {
                      ...
                      default:
                        s.throwError(
                          new p.default(
                            l.default.badResponse,
                            "received bad oauth endpoint, endpoint value is: " +
                              e.endpoint
                          )
                        );
                    }
                    ...
                    if (e.switchAccount)
                      ...
                      t = f.appendQueryString(
                        t,
                        "domain_hint",
                        e.isConsumerAccount ? "consumers" : "organizations"
                      );
                    }
                    f.redirect(t);
                  })(JSON.parse(e[m]))
            ...
            function b(e, t) {
              if (e.state) {
                2 !== e.state.split("_").length &&
                  s
                    .throwError(
                      new p.default(
                        l.default.badResponse,
                        "received bad state parameter from Oauth endpoint, state received: " +
                          e.state
                      )
                    )
                    .exposeToPublic();
                t
                  ? t.send(w + JSON.stringify(e), window.location.origin)
                  : s
                      .throwError(
                        new p.default(
                          l.default.popupOpen,
                          "opener is not defined"
                        )
                      )
                      .exposeToPublic();
              } else
                s.throwError(
                  new p.default(
                    l.default.badResponse,
                    "missing state parameter from Oauth redirect"
                  )
                ).exposeToPublic();
            }
            t.auth = function (e, a) {
              ...
              return new i.Promise(function (i, n) {
                  ...
                  if (e.data && 0 === e.data.indexOf(w)) {
                    ...
                    if (t.state === s && e.source === a.getPopupWindow()) {
                      ...
                      n(
                        new p.default(
                          l.default.popupOpen,
                          "Another popup is already opened."
                        )
                      );
                  }
                });
                return a
                  .openPopup(
                    f.appendQueryString(e.redirectUri, m, JSON.stringify(e))
                  )
                  .then(function () {
            ...
            t.buildOauthConfig = function (t, e) {
              ...
              var i = t.scopes.map(function (e) {
                  return (
                    e +
                    (-1 < e.indexOf("Files.") && t.needSharePointPermission
                      ? ".All"
                      : "")
                  );
                }),
            ...
            e("../utilities/Channel"),
            e("../models/DomainHint"),
            e("../utilities/DomUtilities"),
            e("../utilities/ErrorHandler"),
            e("../models/ErrorType"),
            e("./LoginCache"),
            e("../models/OauthEndpoint"),
            e("../models/OneDriveSdkError"),
            e("es6-promise"),
            e("../utilities/UrlUtilities")
          );
          ...
          !(function (e, t, r, n, o, i, a, s, u, l, d) {
            ...
            var c = (function (i) {
              ...
              t.prototype.queryItems = function (e, t) {
                var r =
                  this.invokerOptions.queryParameters ||
                  o.default.DEFAULT_QUERY_ITEM_PARAMETER;
                t &&
                  (r = l.format(
                    "{0}{1}{2}",
                    r,
                    -1 === r.indexOf("select") ? "&select=" : ",",
                    "name,size,@content.downloadUrl"
                  ));
              ...
              t.prototype.shareItems = function (e) {
                var t = this,
                  r =
                    this.invokerOptions.createLinkParameters ||
                    this.getDefaultSharingConfig();
                return n
                  .getItems(e, this.getApiRequestConfig())
                  .then(function (e) {
              ...
              t.prototype.getDefaultSharingConfig = function () {
                var e = { type: "view" };
                if (
                  this.getApiRequestConfig().apiEndpoint ===
                    r.default.graph_odc ||
                  this.getApiRequestConfig().apiEndpoint === r.default.msa
                )
                  return e;
            ...
            e("./Invoker"),
            e("../utilities/ObjectUtilities"),
            e("../models/PickerOptions"),
            e("../models/PickerActionType"),
            e("../utilities/StringUtilities"),
            e("../utilities/UrlUtilities")
          );
        },
                  ...
                  t ||
                    i
                      .throwError(
                        new a.default(
                          n.default.optionsError,
                          "the site url must be specified"
                        )
                      )
                      .exposeToPublic();
                  s.validateUrlProtocol(t, ["HTTPS"]);
                  e === r.default.graph_odb &&
                    (t = s.appendToPath(t, "_layouts/onedrive.aspx"));
              ...
              e.prototype.invokePickerUX = function (d, c) {
                ...
                return new u.Promise(function (u, e) {
                  var l = h.onMessage(function (e) {
                      var t = p.url.split("/"),
                        r = new f.default(
                          p.iframe ? p.iframe.contentWindow : c.getPopupWindow()
                        );
                      if (e.origin === t[0] + "//" + t[2]) {
                        var i = "" + (e.data || "");
                        if (
                          0 === i.indexOf(m) &&
                          e.source === r.getReceiver()
                        ) {
          ...
          !(function (e, t, n, o, r, a, s, u, l, d) {
            ...
            var i = (function (i) {
              ...
              e.prototype.makeApiRequest = function (e) {
                ...
                if (
                  t.uploadType === l.default.dataUrl ||
                  t.uploadType === l.default.url
                ) {
                  var i = { name: t.fileName };
                  return n.saveItemByUriUpload(
                    e.value[0],
                    i,
                    t.sourceUri,
            ...
            e("./Invoker"),
            e("../utilities/ObjectUtilities"),
            e("../models/SaverActionType"),
            e("../models/SaverOptions"),
            e("../models/UploadType"),
            e("../utilities/UrlUtilities")
          );
        },
            ...
            var r = new RegExp(
              ...
              i = (function () {
                function n(e) {
                  ...
                  this.clientId = f.validateType(
                    e.clientId,
                    a.default.TYPE_STRING
                  );
                  ...
                  this.redirectUri =
                    this.redirectUri || h.trimUrlQuery(window.location.href);
                  ...
                  this.forceAuthenticate =
                    e.advanced && e.advanced.forceAuthenticate;
                  n.checkClientId(this.clientId);
                }
                n.checkClientId = function (e) {
                  e
                    ? r.test(e)
                      ? d.default.logMessage("parsed client id: " + e)
                      : u.throwError(
                          new c.default(
                            l.default.unknown,
                            p.format(
                              "invalid format for client id '{0}' - AAD: 32 characters (HEX) GUID",
                              e
                            )
                          )
                        )
                    : u.throwError(
                        new c.default(
                          l.default.unknown,
                          "client id is missing in options"
                        )
                      );
                };
                n.prototype.needOauth = function () {
                  return (
                    !!this.forceAuthenticate ||
                    (this.needAPICall() && !this.accessToken) ||
                    this.endpointHint === s.default.aad
                  );
                };
                n.prototype.parseAdvancedOptions = function (e) {
                  if (e.advanced) {
                    ...
                    if (e.advanced.queryParameters) {
                      var t = h.readUrlParameters(
                        "?" + e.advanced.queryParameters
                      );
                      for (var r in t)
                        "select" !== r.toLowerCase() &&
                          ...
                          u.throwError(
                            new c.default(
                              l.default.optionsError,
                              p.format(
                                "unexpected query key: {0} is found in advanced.queryParameters",
                                r
                              )
                            )
                          );
                      var i = t.select,
                        n = t.expand;
                      i && n
                        ? (this.queryParameters = p.format(
                            "expand={0}&select={1}",
                            n,
                            i
                          ))
                        : n
                        ? (this.queryParameters = p.format("expand={0}", n))
                        : i &&
                          "select=" + i.split(",").sort().join(",") !==
                            a.default.DEFAULT_QUERY_ITEM_PARAMETER &&
                          (this.queryParameters = p.format("select={0}", i));
                    }
                    if (e.advanced.endpointHint) {
                      if (
                        e.advanced.endpointHint.toLowerCase() ===
                        a.default.VROOM_ENDPOINT_HINT
                      ) {
                        this.endpointHint = s.default.msa;
                        void 0 === e.advanced.isConsumerAccount &&
                          (this.isConsumerAccount = !0);
                      } else {
                        var o = f.validateType(
                          e.advanced.endpointHint,
                          "string",
                          !1
                        );
                        ...
                        void 0 === e.advanced.isConsumerAccount &&
                          (this.isConsumerAccount = !1);
                        this.siteUrl = o;
                      }
                      e.advanced.accessToken &&
                        (this.accessToken = e.advanced.accessToken);
                    }
                    if (e.advanced.iframeParentDiv) {
                      (e.advanced.iframeParentDiv.nodeName &&
                        "div" ===
                          e.advanced.iframeParentDiv.nodeName.toLowerCase()) ||
                        u
                          .throwError(
                            new c.default(
                              l.default.optionsError,
                              "the iframe's parent div element is not a DOM object"
                            )
                          )
                          .exposeToPublic();
                    ...
                    e.advanced.scopes &&
                      ("string" == typeof e.advanced.scopes
                        ? (this.scopes = [e.advanced.scopes])
                        : e.advanced.scopes instanceof Array &&
                          (this.scopes = e.advanced.scopes));
                    ...
                    "boolean" == typeof e.advanced.isConsumerAccount &&
                      (this.isConsumerAccount = e.advanced.isConsumerAccount);
                ...
                n.prototype.parseNavigationOptions = function (e) {
                  if (e) {
                    ...
                    var o =
                      e.sourceTypes instanceof Array
                        ? e.sourceTypes
                        : e.sourceTypes
                        ? [e.sourceTypes]
                        : null;
                    if (o) {
                      this.needSharePointPermission = !(
                        1 === o.length && "onedrive" === o[0].toLowerCase()
                      );
      ...
      16: [
          ...
          !(function (e, t, n, r) {
            ...
            var i = (function (i) {
              ...
              e.prototype.toString = function () {
                return r.format(
                  "[OneDriveSDK Error] errorType: {0}, message: {1}",
                  this.errorCode,
                  this.message
                );
              };
        ...
        { "../models/ErrorType": 13, "../utilities/StringUtilities": 30 },
      ],
      17: [
        function (e, t, r) {
          !(function (e, t) {
          ...
          !(function (e, t, o, a, r, s, u, l) {
            ...
            var i = (function (n) {
              ...
              function e(e) {
                ...
                t.multiSelect = l.validateType(
                  e.multiSelect,
                  a.default.TYPE_BOOLEAN,
                  !0,
                  !1
                );
                var i = l.validateType(
                  e.action,
                  a.default.TYPE_STRING,
                  !0,
                  u.default[u.default.query]
                );
                t.action = u.default[i];
                t.viewType = l.validateType(
                  e.viewType,
                  a.default.TYPE_STRING,
                  !0,
                  "files"
                );
                t.accountSwitchEnabled = l.validateType(
                  e.accountSwitchEnabled,
                  a.default.TYPE_BOOLEAN,
                  !0,
                  !0
                );
                t.commandMode = l.validateType(
                  e.commandMode,
                  a.default.TYPE_STRING,
                  !0
                );
                t.qosExtraData = l.validateType(
                  e.qosExtraData,
                  a.default.TYPE_OBJECT,
                  !0
                );
                null === t.commandMode && (t.commandMode = void 0);
                null === t.qosExtraData && (t.qosExtraData = void 0);
                e.advanced &&
                  (t.createLinkParameters = e.advanced.createLinkParameters);
                t.scopes ||
                  (t.scopes = [
                    t.action === u.default.share
                      ? "Files.ReadWrite"
                      : "Files.Read",
                  ]);
                return t;
              ...
              e.prototype.needAPICall = function () {
                return (
                  !!this.queryParameters || this.action !== u.default.query
                );
              };
              return e;
            })(r.default);
          ...
          !(function (e, t, a, s, r, i, n, o, u, l, d, c, p, f, h) {
            ...
            var v = (function (o) {
              ...
              function e(e) {
                ...
                var n = p.validateType(
                  e.action,
                  s.default.TYPE_STRING,
                  !0,
                  d.default[d.default.query]
                );
                t.action = d.default[n];
                t.action === d.default.save && t._setFileInfo(e);
                t.nameConflictBehavior = p.validateType(
                  e.nameConflictBehavior,
                  s.default.TYPE_STRING,
                  !0,
                  "rename"
                );
                t.scopes || (t.scopes = ["Files.ReadWrite"]);
                t.commandMode = p.validateType(
                  e.commandMode,
                  s.default.TYPE_STRING,
                  !0
                );
                t.qosExtraData = p.validateType(
                  e.qosExtraData,
                  s.default.TYPE_OBJECT,
                  !0
                );
                null === t.commandMode && (t.commandMode = void 0);
                null === t.qosExtraData && (t.qosExtraData = void 0);
              ...
              e.prototype._setFileInfo = function (e) {
                e.sourceInputElementId &&
                  e.sourceUri &&
                  i.throwError(
                    new l.default(
                      n.default.optionsError,
                      "sourceUri and sourceInputElementId are provided, only one is required."
                    )
                  );
                this.sourceInputElementId = e.sourceInputElementId;
                this.sourceUri = e.sourceUri;
                var t = p.validateType(
                  e.fileName,
                  s.default.TYPE_STRING,
                  !0,
                  null
                ...
                if (this.sourceUri) {
                  if (h.isPathFullUrl(this.sourceUri)) {
                    ...
                    this.fileName ||
                      i.throwError(
                        new l.default(
                          n.default.optionsError,
                          "must supply a file name or a URL that ends with a file name"
                        )
                      );
                    ...
                    this.fileName ||
                      i.throwError(
                        new l.default(
                          n.default.optionsError,
                          "must supply a file name for data URL uploads"
                        )
                      );
                  }
                  ...
                  i.throwError(
                    new l.default(
                      n.default.optionsError,
                      "please specified one type of resource to save"
                    )
                  );
              };
              return e;
            ...
            t.getFileInput = function (e) {
              ...
              if (t instanceof HTMLInputElement) {
                "file" !== t.type &&
                  n.throwError(
                    new a.default(
                      o.default.optionsError,
                      "input elemenet must be of type 'file'"
                    )
                  );
                if (!t.value) {
                  n.throwError(
                ...
                (r && window.FileReader) ||
                  n.throwError(
                    new a.default(
                      o.default.unsupportedFeature,
                      "browser does not support Files API"
                    )
                  );
                1 !== r.length &&
                  n.throwError(
                ...
                i ||
                  n.throwError(
                    new a.default(o.default.optionsError, "missing file input")
                  );
                if (104857600 < i.size) {
                  n.throwError(
                    new a.default(
                      o.default.optionsError,
                      "the user has selected a file larger than 100 MB"
                    )
                  );
                  return null;
                }
              ...
              n.throwError(
                new a.default(
                  o.default.unknown,
                  "element was not an instance of an HTMLInputElement"
                )
              );
            };
            t.displayOverlay = function () {
              ...
              u(function () {
                ...
                null !== e
                  ...
                  : document.createElement("body").appendChild(t);
          ...
          !(function (e, t, i) {
            ...
            t.throwError = function (e) {
              if (e.errorCode !== i.default[i.default.unknown]) {
                for (var t = 0, r = n; t < r.length; t++) (0, r[t])(e);
                return {
          ...
          !(function (e, t) {
            ...
            var r = (function () {
              ...
              n._log = function (e, t) {
                for (var r = [], i = 2; i < arguments.length; i++)
                  r[i - 2] = arguments[i];
                (t || n.loggingEnabled || window.onedrive_enable_logging) &&
                  console.log("[OneDriveSDK] " + e, r);
              };
              n.loggingEnabled = !1;
              return n;
            })();
        ...
        function (e, t, r) {
          !(function (e, t, i, r) {
            ...
            t.shallowClone = function (e) {
              if (typeof e !== i.default.TYPE_OBJECT || !e) return null;
              var t = {};
          ...
          !(function (e, n, r, o, a, s, u) {
            ...
            var t = (function () {
              ...
              t.createPopupFeatures = function () {
                var e =
                  window.screenX + Math.max(window.outerWidth - 1024, 0) / 2;
                return [
                  "width=1024",
                  "height=650",
                  "top=" +
                    (window.screenY +
                      Math.max(window.outerHeight - 650, 0) / 2),
                  "left=" + e,
                  "status=no",
                  "resizable=yes",
                  "toolbar=no",
              ...
              if (void 0 === e) {
                if (r) {
                  ...
                  a.throwError(
                    new d.default(
                      s.default.typeError,
                      "object was missing and not optional"
                    )
                  );
                return null;
              }
              ...
              if (o !== t) {
                a.throwError(
                  new d.default(
                    s.default.typeError,
                    c.format(
                      "expected object type: '{0}', actual object type: '{1}'",
                      t,
                      o
                    )
                  )
              ...
              if (
                ...
                a.throwError(
                  new d.default(
                    s.default.typeError,
                    c.format(
                      "object does not match any valid values {0}",
                      l.serializeJSON(n)
                    )
                  )
                );
              ...
              if (void 0 === e) {
                t ||
                  a.throwError(
                    new d.default(
                      s.default.typeError,
                      "function was missing and not optional"
                    )
                  );
                return null;
              }
              var r = typeof e;
              r !== i.default.TYPE_FUNCTION &&
                a.throwError(
                  new d.default(
                    s.default.typeError,
                    c.format(
                      "expected function type: function | string, actual type: {0}",
                      r
                    )
                  )
                );
          ...
          !(function (e, t, i, o, a, s, u) {
            ...
            function f(e, t) {
              for (var r = 0, i = (t = t || [l, d]); r < i.length; r++) {
                var n = i[r];
                if (0 === e.toUpperCase().indexOf(n)) return;
              }
              o.throwError(
                new s.default(
                  a.default.optionsError,
                  u.format("uri {0} does not match protocol(s): " + t, e)
                )
              ).exposeToPublic();
            }
            ...
            t.validateRedirectUrlHost = function (e) {
              f(e);
              -1 < e.indexOf("://")
                ? e.split("/")[2] !== window.location.host &&
                  o
                    .throwError(
                      new s.default(
                        a.default.optionsError,
                ...
                : o
                    .throwError(
                      new s.default(
                        a.default.optionsError,
                        "redirect uri is not an absolute url"
                      )
                    )
                    .exposeToPublic();
            };
            ...
            var c = new RegExp("^([a-fA-F0-9]){16}$"),
              r = (function () {
                ...
                o.prototype.start = function (e, t) {
                  ...
                  try {
                    ...
                    this._request.onload = function () {
                      ...
                      e < 400 && 0 < e
                        ? r._callSuccessCallback(e)
                        : r._callFailureCallback(e);
                    };
                    this._method ||
                      (this._method = this._json ? o.HTTP_POST : o.HTTP_GET);
                ...
                o.prototype.upload = function (e, t, r, i) {
                  ...
                  try {
                    ...
                    this._request.onload = function (e) {
                      ...
                      200 === t || 201 === t || 202 === t
                        ? n._callSuccessCallback(t)
                        : n._callFailureCallback(t, e);
                    };
                    ...
                    this._request.upload.onprogress = function (e) {
                      if (e.lengthComputable) {
                        var t = {
                          ...
                          totalBytes: e.total,
                          progressPercentage:
                            0 === e.total ? 0 : (e.loaded / e.total) * 100,
                        };
                ...
                o.prototype._callSuccessCallback = function (e) {
                  u.default.logMessage(
                    "calling xhr success callback, status: " +
                      o.statusCodeToString(e)
                  );
                  this._successCallback(this._request, e, this._url);
                };
                o.prototype._callFailureCallback = function (e, t) {
                  u.default.logError(
                    "calling xhr failure callback, status: " +
                      o.statusCodeToString(e),
                    this._request,
                    t
                  );
                ...
                o.prototype._setHeaders = function () {
                  ...
                  switch (this._apiEndpoint) {
                    ...
                    default:
                      a.throwError(
                        new l.default(
                          s.default.internalError,
                          "invalid API endpoint: " + this._apiEndpoint
                        )
                      );
                  }
                  this._method === o.HTTP_POST &&
                    this._request.setRequestHeader(
                      "Content-Type",
                      this._json ? "application/json" : "text/plain"
                    );
                };
                o.HTTP_GET = "GET";
                o.HTTP_POST = "POST";
            ...
            (i = function () {
              ...
              function M(e, t) {
                ...
                if (r(t)) {
                  ...
                  if (0 === this.length) U(this.promise, this._result);
                  else {
              ...
              M.prototype._enumerate = function () {
                for (
                  var e = this.length, t = this._input, r = 0;
                  this._state === _ && r < e;
                  r++
                )
